...
{
	static const u16 bp1[] = { 0x067F, 0xE004, 0xE200, 0x06FF, 0xE004, 0xE200, 0x0000, };
	static const u16 bp2[] = { 0xE080, 0x067F, 0xE008, 0xE080, 0x06FF, 0xE008, 0x0000, };
	static const u16 bp3[] = { 0xE100, 0xE002, 0x067F, 0xE100, 0xE002, 0x06FF, 0x0000, };
