...
/**
 * ec701_fpga_power() - Enable or disable FPGA power
 *
 * Sequence:
 * - Read OTP revision
...
static int ec701_fpga_power(bool enable)
{
...
#error "ec701 needs to have CONFIG_FPGA_ALTERA set"
#endif
 ...
 */
static int ec701_fpga_init_spi_flash(struct fpga_ctrl *fpga)
{
 ...
 */
static int ec701_fpga_uninit_spi_flash(struct fpga_ctrl *fpga)
{
...
static void fpga_set_board_ops(struct fpga_board_ops *ops)
{
	...
	ops->fpga_init_spi_flash = ec701_fpga_init_spi_flash;
	ops->fpga_uninit_spi_flash = ec701_fpga_uninit_spi_flash;
}
