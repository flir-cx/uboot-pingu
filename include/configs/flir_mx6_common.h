 ...
 * Copyright 2018 NXP
 *
 * Configuration settings for the FLIR MX6 series boards.
 */
...
#undef CONFIG_SPLASH_SCREEN   /* No splash screen for MFG - Will destroy preloaded kernel... */
...
#endif /* __FLIR_MX6_COMMON_CONFIG_H */
